...
<div class="text-center">
    <img id="borda_perfil" border-style="inset" border= "5px;" width="304" height="236" src="c1.jpg" class="rounded-circle">
</div>

<br>

<div class="d-flex justify-content-center">
    <a href="alterarFoto.php">
        <button type="submit" class="btn btn-success">ALTERAR FOTO</button>
    </a>
    <form action="">
        <button type="submit" class="btn btn-success">X APAGAR FOTO</button>
    </form>
</div>
